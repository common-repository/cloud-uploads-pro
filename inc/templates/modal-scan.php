	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="scan-modal-label"><?php esc_html_e( 'Scanning Files', 'cloud-uploads' ); ?></h5>
				...
				<div class="container-fluid">
					<div class="row justify-content-center mb-4 mt-3">
						<div class="col text-center">
							...
							<h4><?php esc_html_e( 'Scanning Local Filesystem', 'cloud-uploads' ); ?></h4>
							<p class="lead"><?php esc_html_e( "This usually only takes a minute or two but can take longer for very large media libraries with a lot of files. Please leave this tab open while we complete your scan.", 'cloud-uploads' ); ?></p>
						</div>
					</div>
					<div class="row justify-content-center mb-4">
						<div class="col text-center text-muted">
							<span class="h5" id="cup-scan-progress">
								<?php
								printf(
								...
								// translators: %4$s is the closing a tag for files
									esc_html__( 'Found %1$s0 MB%2$s / %3$s0%4$s Files...', 'cloud-uploads' ),
									'<span id="cloud-scan-storage">', '</span>', '<span id="cloud-scan-files">', '</span>' );
								?>
							</span>
						</div>
					</div>
